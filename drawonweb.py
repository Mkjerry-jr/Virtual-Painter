...
def generate_frames():
    ...
    hands = HandsDetection(num_hands=1, detection_confidence=0.6, static_mode=False, tracking_confidence=0.6)
    ...
    while video.isOpened():
        ...
        ret, buffer = cv2.imencode('.jpg', cv2.cvtColor(output, cv2.COLOR_BGR2RGB))
